// src/components/individuals/FinalCTA.tsx
'use client';
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <a 
            ...
            className="bg-black text-white hover:bg-gray-900 font-semibold py-4 px-8 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl border-2 border-transparent text-center"
          >
            Start Your Photoshoot Now
          </a>
          <a 
            href="/packages"
            className="bg-white text-black hover:bg-gray-100 font-semibold py-4 px-8 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl border-2 border-transparent text-center"
          >
            View All Packages
          </a>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-white/20">
          <p className="text-lg mb-4">Trusted by professionals and individuals across Ghana</p>
        ...
        <div className="mt-12">
          <p className="text-sm text-white/80 mb-4">Prefer to chat first?</p>
          <a 
            href="https://wa.me/233207472307?text=Hi%20Radikal!%20I'm%20interested%20in%20your%20virtual%20photoshoot%20services"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center bg-[#25D366] hover:bg-[#128C7E] text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105"
          >
