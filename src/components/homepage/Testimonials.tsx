// src/components/homepage/Testimonials.tsx - ENHANCED
'use client';
import { useState, useEffect } from 'react';
import { Star, MessageCircle, User, ChevronDown, Filter, Quote } from 'lucide-react';
                  ...
                  {isWhatsApp ? (
                    <div className="text-center">
                      ...
                      <div className="flex items-center justify-center mb-3">
                        ...
                        <span className="text-sm font-bold text-gray-700 ml-2">({rating})</span>
                      </div>

                      {/* WhatsApp Testimonial Text */}
                      <div className="relative mb-4">
                        <Quote className="w-6 h-6 text-gray-300 absolute -top-2 -left-1" />
                        <p className="text-gray-700 italic leading-relaxed group-hover:text-gray-900 transition-colors duration-300 text-sm md:text-base pl-4">
                          {testimonial.text}
                        </p>
                      </div>
